                ...
                <div className="col-12 col-md-6 d-flex flex-column justify-content-between p-5 min-vh-100">
                        ...
                        <form onSubmit={(e) => e.preventDefault()}>
                            ...
                            <div className="mb-4 form-check d-flex align-items-center gap-2 ps-0">
                                <input 
                                    ...
                                    required
                                />
                                <label className="form-check-label text-secondary small" htmlFor="agreeTerms" style={{ cursor: 'pointer', userSelect: 'none' }}>
                    ...
                    <div className="d-flex justify-content-start align-items-center w-100 mt-4" style={{ fontSize: '13px' }}>
                        <span className="text-muted">
                            Already have an account? <Link to="/login" className="text-primary text-decoration-underline fw-medium" style={{ cursor: 'pointer' }}>Sign in</Link>
                        </span>
                    </div>
                </div>

                {/* ─── ডান কলাম: জ্যামিতিক ব্যাকগ্রাউন্ড (লগইন থিমের সাথে ম্যাচিং) ─── */}
                <div 
